...
rpt_last_hash_cache = ThreadSafeCache(ttl=3600, max_size=1)
...
grievance_list_cache = ThreadSafeCache(ttl=300, max_size=20) # 5 minutes TTL
escalation_stats_cache = ThreadSafeCache(ttl=600, max_size=1) # 10 minutes TTL
visit_stats_cache = ThreadSafeCache(ttl=600, max_size=1) # 10 minutes TTL
