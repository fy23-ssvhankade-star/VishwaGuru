...
const GarbageDetector = ({ onBack }) => {
    ...
    return (
        <div className="mt-6 flex flex-col items-center w-full">
            <h2 className="text-xl font-semibold mb-4 text-center">Live Garbage Detector</h2>
            ...
            <button
                ...
                className={`w-full max-w-md py-3 px-4 rounded-lg text-white font-medium shadow-md transition transform active:scale-95 ${isDetecting ? 'bg-red-600 hover:bg-red-700' : 'bg-orange-600 hover:bg-orange-700'}`}
            >
                {isDetecting ? 'Stop Detection' : 'Start Live Garbage Detection'}
            </button>
