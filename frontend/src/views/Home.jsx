        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
          ...
          <div className="xl:col-span-4 space-y-6">
            ...
            >
              ...
              <div className="text-left">
                <span className="block text-xl font-black leading-tight">Civic Eye</span>
                <span className="text-[10px] font-black uppercase tracking-widest opacity-80 mt-1 block">Safety Checker</span>
              </div>
            </motion.button>
