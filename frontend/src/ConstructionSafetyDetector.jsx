  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 max-w-md mx-auto w-full">
        <h2 className="text-2xl font-bold mb-4">Construction Safety Detector</h2>
        ...
        <div className="flex justify-center gap-4">
          {!imgSrc ? (
            <button
              ...
              className={`bg-orange-600 text-white px-6 py-2 rounded-full font-semibold shadow-md hover:bg-orange-700 transition ${cameraError ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
              Capture Photo
            </button>
          ) : (
            <>
              ...
              <button
                ...
                disabled={loading}
                className={`bg-orange-600 text-white px-6 py-2 rounded-full font-semibold shadow-md hover:bg-orange-700 transition flex items-center ${loading ? 'opacity-70 cursor-wait' : ''}`}
              >
                {loading ? (
                    <>
        ...
        <p className="mt-4 text-sm text-gray-600 text-center">
          Point camera at construction sites to check for safety violations.
        </p>
      </div>
    </div>
  );
